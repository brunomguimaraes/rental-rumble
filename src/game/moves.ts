...
import { LINE_SIGNATURES } from './signatures.js';
...
const TYPE_KITS: Record<PokemonType, TypeKit> = {
  ...
  electric: {
    physical: {
      safe: [
        mk('Thunder Punch', 'electric', 75, 1, { kind: 'stun', chance: 0.1 }, 'physical'),
        mk('Thunder Fang', 'electric', 65, 0.95, { kind: 'stun', chance: 0.1 }, 'physical'),
      ],
  ...
  ground: {
    ...
    energy: {
      safe: [
        ...
        mk('Scorching Sands', 'ground', 70, 1, { kind: 'burn', chance: 0.3 }, 'energy'),
      ],
    },
  },
  flying: {
  ...
  rock: {
    ...
    energy: {
      safe: [
        mk('Power Gem', 'rock', 80, 1, undefined, 'energy'),
        mk('Ancient Power', 'rock', 70, 1, undefined, 'energy'),
      ],
    },
  },
  ghost: {
  ...
  dragon: {
    ...
    energy: {
      safe: [
        ...
        mk('Dragon Breath', 'dragon', 65, 1, { kind: 'stun', chance: 0.3 }),
      ],
    },
  },
  dark: {
  ...
  steel: {
    ...
    energy: {
      safe: [
        ...
        mk('Mirror Shot', 'steel', 75, 0.95, undefined, 'energy'),
      ],
    },
  },
  fairy: {
    physical: {
      safe: [
        ...
        mk(
          ...
          75,
          1,
          { kind: 'stage', stat: 'eatk', delta: -1, chance: 0.3, target: 'foe' },
          'physical',
        ),
      ],
    },
...
// The per-line signature DATA lives in ./signatures.ts (imported above); the
// resolution + stage-scaling logic stays here. Authored per generation.
